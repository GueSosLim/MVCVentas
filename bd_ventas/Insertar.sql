...
values ('1','admin','e10adc3949ba59abbe56e057f20f883e','Administrador','Admin','admin@hotmail.com','A')
insert into usuario(idtipousuario,idusuario,password,nombre,apellidos,email,estado) 
values ('2','elanchipa','e10adc3949ba59abbe56e057f20f883e','Enrique','Lanchipa Valencia','elanchipa@hotmail.es','I')
insert into usuario(idtipousuario,idusuario,password,nombre,apellidos,email,estado) 
values ('3','mflores','e10adc3949ba59abbe56e057f20f883e','Maria','Flores','mflores@upt.edu.pe','A')
insert into usuario(idtipousuario,idusuario,password,nombre,apellidos,email,estado) 
values ('3','jsanchez','e10adc3949ba59abbe56e057f20f883e','Jony','Sanchez','jsanchez@yahoo.es','A')

insert into pedido(fecha,estado,idusuario) values ('2015-01-20','Realizado','admin')
insert into pedido(fecha,estado,idusuario) values ('2015-01-20','Realizado','elanchipa')
insert into pedido(fecha,estado,idusuario) values ('2015-01-21','Realizado','mflores')
insert into pedido(fecha,estado,idusuario) values ('2015-01-21','Realizado','jsanchez')
